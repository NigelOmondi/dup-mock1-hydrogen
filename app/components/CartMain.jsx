      ...
      <div className="cart-main flex-1 ">
        {cartHasItems && (
          <div className="sticky top-0 left-0 right-0 pb-2 bg-white">
            <p
              className={`mb-2 mx-4 text-start font-semibold ${isFreeShippingUnlocked ? 'text-green-600' : 'text-purple-700'}`}
            >
              {isFreeShippingUnlocked ? (
                ...
                <>
                  Spend <strong> Kes {FREE_SHIPPING_GOAL - subtotal}</strong>{' '}
                  more and get
        ...
        <div className="cart-details">
          <div aria-labelledby="cart-lines">
            ...
            <div className="cart-upsell-products pb-8 lg:hidden flex-1 md:max-h-[calc(100vh-var(--cart-aside-recommended-height))] md:overflow-y-auto">
              <h2 className="text-lg font-bold mb-2">
                Additional Items You May Like
              </h2>
              <div className="grid grid-cols-2 gap-4">
                {products.map((product) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span className="inline-block bg-black text-white px-8 md:px-12 py-2 rounded text-sm">
                          {isLoading ? 'Adding...' : 'Add to Cart'}
                        </span>
                      </AddToCartButton>
                    </div>
